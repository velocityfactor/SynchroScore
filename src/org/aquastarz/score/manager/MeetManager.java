...
public class MeetManager {
	...
	public static void exportMeet(Meet meet, File file) throws IOException {
		...
		writer.write("\n");
		writer.write("NovFigure1,\"" + meet.getNov1Figure().getFigureId()
				+ "\",\"" + meet.getNov1Figure().getName() + "\"\n");
		writer.write("NovFigure2,\"" + meet.getNov2Figure().getFigureId()
				+ "\",\"" + meet.getNov2Figure().getName() + "\"\n");
		writer.write("NovFigure3,\"" + meet.getNov3Figure().getFigureId()
				+ "\",\"" + meet.getNov3Figure().getName() + "\"\n");
		writer.write("NovFigure4,\"" + meet.getNov4Figure().getFigureId()
				+ "\",\"" + meet.getNov4Figure().getName() + "\"\n");
		writer.write("IntFigure1,\"" + meet.getInt1Figure().getFigureId()
				+ "\",\"" + meet.getInt1Figure().getName() + "\"\n");
		writer.write("IntFigure2,\"" + meet.getInt2Figure().getFigureId()
				+ "\",\"" + meet.getInt2Figure().getName() + "\"\n");
		writer.write("IntFigure3,\"" + meet.getInt3Figure().getFigureId()
				+ "\",\"" + meet.getInt3Figure().getName() + "\"\n");
		writer.write("IntFigure4,\"" + meet.getInt4Figure().getFigureId()
				+ "\",\"" + meet.getInt4Figure().getName() + "\"\n");
		writer.write("EUFigs,\"" + meet.isEu1() + "\",\"" + meet.isEu2()
				+ "\",\"" + meet.isEu3() + "\",\"" + meet.isEu4() + "\"\n");
		...
		for (Routine r : meet.getRoutines()) {
			writer.write("Routine," + r.getRoutineOrder() + ","
					+ r.getTeam().getTeamId() + "," + r.getLevel().getLevelId()
					+ "," + r.getRoutineType() + "," + r.getNumSwimmers()
					+ ",\"" + r.getName() + "\",\"" + r.getSwimmers1()
					+ "\",\"" + r.getSwimmers2() + "\"," + r.getAScore1() + ","
					+ r.getAScore2() + "," + r.getAScore3() + ","
					+ r.getAScore4() + "," + r.getAScore5() + ","
					+ r.getAScore6() + "," + r.getAScore7() + ","
					+ r.getTScore1() + "," + r.getTScore2() + ","
					+ r.getTScore3() + "," + r.getTScore4() + ","
					+ r.getTScore5() + "," + r.getTScore6() + ","
					+ r.getTScore7() + "," + r.getPenalty() + "\n");
		}
		writer.close();
	}
	...
	public static String getFiguresParticipantExport(FiguresParticipant fp) {
		...
		sb.append("FiguresParticipant,\"").append(fp.getFigureOrder())
				.append("\",").append(fp.getSwimmer().getLeagueNum())
				.append(",\"").append(fp.getSwimmer().getFirstName())
				.append("\",\"").append(fp.getSwimmer().getLastName())
				.append("\",\"")
				.append(fp.getSwimmer().getLevel().getLevelId())
				.append("\",\"").append(fp.getSwimmer().getTeam().getTeamId())
				.append("\"\n");
		for (FigureScore fs : fp.getFiguresScores()) {
			sb.append("FigureScore,\"").append(fp.getFigureOrder())
					.append("\",").append(fs.getStation()).append(",")
					.append(fs.getScore1()).append(",").append(fs.getScore2())
					.append(",").append(fs.getScore3()).append(",")
					.append(fs.getScore4()).append(",").append(fs.getScore5())
					.append(",").append(fs.getPenalty()).append("\n");
		}
		return sb.toString();
	}
		...
		try {
			...
			for (String[] sa : rows) {
				...
				if ("FiguresParticipant".equals(sa[0])) {
					...
					fp.setSwimmer(SwimmerManager.findByLeagueNum(
							Integer.parseInt(sa[2]), meet.getSeason()));
				...
				if ("FigureScore".equals(sa[0])) {
					...
					fs.setScore1("null".equals(sa[3]) ? null : new BigDecimal(
							sa[3]));
					fs.setScore2("null".equals(sa[4]) ? null : new BigDecimal(
							sa[4]));
					fs.setScore3("null".equals(sa[5]) ? null : new BigDecimal(
							sa[5]));
					fs.setScore4("null".equals(sa[6]) ? null : new BigDecimal(
							sa[6]));
					fs.setScore5("null".equals(sa[7]) ? null : new BigDecimal(
							sa[7]));
					fs.setPenalty("null".equals(sa[8]) ? null : new BigDecimal(
							sa[8]));
				...
				if ("Routine".equals(sa[0])) {
					...
					r.setSwimmers1(sa[7]);
					r.setSwimmers2(sa[8]);
					r.setAScore1("null".equals(sa[9]) ? null : new BigDecimal(
							sa[9]));
					r.setAScore2("null".equals(sa[10]) ? null : new BigDecimal(
							sa[10]));
					r.setAScore3("null".equals(sa[11]) ? null : new BigDecimal(
							sa[11]));
					r.setAScore4("null".equals(sa[12]) ? null : new BigDecimal(
							sa[12]));
					r.setAScore5("null".equals(sa[13]) ? null : new BigDecimal(
							sa[13]));
					r.setAScore6("null".equals(sa[14]) ? null : new BigDecimal(
							sa[14]));
					r.setAScore7("null".equals(sa[15]) ? null : new BigDecimal(
							sa[15]));
					r.setTScore1("null".equals(sa[16]) ? null : new BigDecimal(
							sa[16]));
					r.setTScore2("null".equals(sa[17]) ? null : new BigDecimal(
							sa[17]));
					r.setTScore3("null".equals(sa[18]) ? null : new BigDecimal(
							sa[18]));
					r.setTScore4("null".equals(sa[19]) ? null : new BigDecimal(
							sa[19]));
					r.setTScore5("null".equals(sa[20]) ? null : new BigDecimal(
							sa[20]));
					r.setTScore6("null".equals(sa[21]) ? null : new BigDecimal(
							sa[21]));
					r.setTScore7("null".equals(sa[22]) ? null : new BigDecimal(
							sa[22]));
					r.setPenalty("null".equals(sa[23]) ? null : new BigDecimal(
							sa[23]));
	...
	public static List<String> compareMeets(Meet meet1, Meet meet2) {
		...
		for (FiguresParticipant fp2 : meet2.getFiguresParticipants()) {
			for (FigureScore fs2 : fp2.getFiguresScores()) {
				FigureScore fs1 = fsMap.get(fp2.getFigureOrder() + "-"
						+ fs2.getStation());
				if (fs1 == null) {
					errors.add("Missing figure score " + fs2.getStation()
							+ " for swimmer #" + fp2.getFigureOrder());
				} else {
					if (!fs1.equals(fs2)) {
						errors.add("Mismatched figure score "
								+ fs2.getStation() + " for swimmer #"
								+ fp2.getFigureOrder());
					}
		...
		for (FigureScore fs1 : fsMap.values()) {
			errors.add("Extra figure score " + fs1.getStation()
					+ " for swimmer #"
		...
		for (Routine routine2 : meet2.getRoutines()) {
			...
			if (routine1 == null) {
				...
				if (!routine1.equals(routine2)) {
					errors.add("Mismatched routine score for \""
							+ routine1.getName() + "\"");
				}
	...
	public static void importMeet(File file) throws IOException {
		try {
			...
			try {
				...
				throw new IOException("Error commmitting meet to database.  "
						+ e.getMessage());
			}
		} catch (Exception e) {
