...
public class RoutineManager {
    ...
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(RoutineManager.class.getName());
    ...
    public static BigDecimal calcChampsPlacePoints(int place, String routineType, int tieCount) {
    ...
    public static String getMisspelledNames(Routine routine) {
        String s = (routine.getSwimmers1() != null ? routine.getSwimmers1() + "," : "") + (routine.getSwimmers2() != null ? routine.getSwimmers2() : "");
        ...
        for (String name : names) {
            ...
            if (!name.isEmpty()) {
                ...
                String correctName = SwimmerManager.findNameLikeName(name.substring(0, space), name.substring(space + 1), ScoreApp.getCurrentSeason());
