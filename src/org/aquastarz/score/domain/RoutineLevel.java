...
@NamedQueries({
		@NamedQuery(name = "RoutineLevel.findAllInOrder", query = "SELECT r FROM RoutineLevel r ORDER BY r.sortOrder"),
		@NamedQuery(name = "RoutineLevel.findByRoutineLevelId", query = "SELECT r FROM RoutineLevel r WHERE r.routineLevelId = :routineLevelId"),
		@NamedQuery(name = "RoutineLevel.findByName", query = "SELECT r FROM RoutineLevel r WHERE r.name = :name") })
public class RoutineLevel implements Serializable {
	...
	public void setLevelId(String routineLevelId) {
		...
		this.routineLevelId = routineLevelId;
		changeSupport.firePropertyChange("routineLevelId", oldLevelId,
				routineLevelId);
	}
	...
	public boolean equals(Object object) {
		...
		if ((this.routineLevelId == null && other.routineLevelId != null)
				|| (this.routineLevelId != null && !this.routineLevelId
						.equals(other.routineLevelId))) {
			return false;
		}
		return true;
	}
