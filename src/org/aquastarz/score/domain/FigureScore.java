...
public class FigureScore implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if (this.figureScoreId != null
				&& this.figureScoreId.equals(other.figureScoreId)) {
			return true;
		} else {
			if ((this.score1 == null && other.score1 != null)
					|| (this.score1 != null && !this.score1
							.equals(other.score1))) {
				return false;
			}
			if ((this.score2 == null && other.score2 != null)
					|| (this.score2 != null && !this.score2
							.equals(other.score2))) {
				return false;
			}
			if ((this.score3 == null && other.score3 != null)
					|| (this.score3 != null && !this.score3
							.equals(other.score3))) {
				return false;
			}
			if ((this.score4 == null && other.score4 != null)
					|| (this.score4 != null && !this.score4
							.equals(other.score4))) {
				return false;
			}
			if ((this.score5 == null && other.score5 != null)
					|| (this.score5 != null && !this.score5
							.equals(other.score5))) {
				return false;
			}
	...
	public String toString() {
		return "FigureScore #" + figureScoreId + " s1=" + score1 + " s2="
				+ score2 + " s3=" + score3 + " s4=" + score4 + " s5=" + score5
				+ " pen=" + penalty + " station=" + station;
	}
}
