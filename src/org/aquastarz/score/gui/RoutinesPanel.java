...
public class RoutinesPanel extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		layout.setVerticalGroup(layout
				...
				.addGroup(
						layout.createSequentialGroup()
								...
								.addContainerGap()));
		layout.linkSize(SwingConstants.VERTICAL, new Component[] { teamCombo,
				levelCombo, routineTypeCombo });
		...
		layout.linkSize(SwingConstants.HORIZONTAL, new Component[] {
				printButton, importButton, randomizeButton, saveButton,
				addButton, deleteButton, spellCheckButton,btnPrintSheets });
