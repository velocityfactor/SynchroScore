...
//Stolen from https://jdnc-incubator.dev.java.net/source/browse/jdnc-incubator/trunk/src/kleopatra/java/org/jdesktop/beansbindingx/VetoableListSelectionModel.java?rev=1850&view=markup
...
//--------------------- vetoable support
    ...
    public void removeSelectionInterval(int index0, int index1) {
        if (isSelectionEmpty() || invalidRange(index0, index1)) {
            return;
        }
